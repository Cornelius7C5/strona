<div id="header-wrapper">
    <div id="header" class="container">
        ...
        if (login_check($mysqli) == true) {
            echo '<a href="../logout.php"><div id="login_button">Wyloguj</div></a>';
        } else {
            echo '<a href="../login.php"><div id="login_button">Zaloguj</div></a>';
        }
        if (isset($_GET['error'])) {
        ...
        <div id="menu">
            <ul>
                ...
                <li class="<? echo $exercises ? 'active' : '' ?>"><a href="inProgress.php" accesskey="4">Ćwiczenia</a>
                </li>
